using DapperGenericRepository.Infrastructure.Abstractions;
using System;
...
namespace DapperGenericRepository.Infrastructure.Implementation
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public async Task<int> CountAll()
        {
            ...
            {
                string tableName = GetTableName();
                string query = $"SELECT COUNT(1) FROM {tableName}"; // May need exact column names
